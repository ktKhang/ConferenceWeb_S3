	...
	<div
		...
		<div
			...
			<div class="signin-logo tx-center tx-28 tx-bold tx-inverse">
				<span class="tx-normal">[</span> ICSSE <span class="tx-normal">]</span>
			</div>
			<div class="tx-center mg-b-60">Log in to admin page</div>
			<form method="post" action="post-login">
				...
				<div class="form-group">
					<input type="password" class="form-control"
						placeholder="Enter your password" name="password"> <a
						href="" class="tx-info tx-12 d-block mg-t-10">Forgot password?</a>
				</div>
				<!-- form-group -->
